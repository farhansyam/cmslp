      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?= uri_string() == 'user/pengaturan' ? 'active' : ''; ?>">
              <a href="<?= site_url('user/pengaturan')?>" class="menu-link">
            ...
            <li class="menu-item  <?= uri_string() == 'user/tentang-kami' ? 'active' : ''; ?>">
              <a href="<?= site_url('user/tentang-kami')?>" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-information-outline"></i>
                <div data-i18n="Tentang Kami">Tentang Kami</div>
              </a>
            </li>
            <li class="menu-item <?= uri_string() == 'user/faq' ? 'active' : ''; ?>">
              <a href="<?= site_url('user/faq')?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo site_url('user/logout')?>" class="menu-link">
