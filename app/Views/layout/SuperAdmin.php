...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header fw-light mt-4">
              <span class="menu-header-text">Data Administrator </span>
            </li>
            <li class="menu-item <?= uri_string() == 'superadmin/admin' ? 'active' : ''; ?>">
              <a href="<?= site_url('superadmin/admin')?>" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-cog-outline"></i>
                <div data-i18n="Data Admin">Data Admin</div>
              </a>
            </li>
            <li class="menu-item <?= uri_string() == 'superadmin/role' ? 'active' : ''; ?>">
 ...
 <li class="menu-item <?= uri_string() == 'superadmin/organisasi' ? 'active' : ''; ?>">
            ...
            <li class="menu-item">
              <a href="<?php echo site_url('superadmin/logout')?>" class="menu-link">
      ...
      <!-- Drag Target Area T
      o SlideIn Menu On Small Screens -->
