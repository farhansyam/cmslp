...
<?php }elseif(session()->get('role_baku') == 2){ ?>
  ...
  <form action="<?= site_url('admins/portofolio/update/'.$portofolio['id_portofolio'])?>" method="post" enctype="multipart/form-data">
 ...
 <script>
        ...
        var myDropzone = new Dropzone("#myDropzone", {
            url: "<?php if(session()->get('role_baku') == 1 ){
                ...
                echo base_url('admins/portofolio/update/'.$portofolio['id_portofolio']); 
            }else{
                echo base_url('user/portofolio/update/'.$portofolio['id_portofolio']); 
            }
            ?>",
