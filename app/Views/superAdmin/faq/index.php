...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <?php if($role['create_data'] == 'Y') {?>
                      <div class="demo-inline-spacing"><?php if(session()->get('role_baku') == 1){ ?>

                        <a href="<?= site_url('superadmin/faq/tambah')?>"><button type="button" class="btn btn-primary waves-effect waves-light">Tambah</button></a>
...
<?php } ?>
     ...
     <?php if($role['update_data'] == 'Y') {?>
                              <a class="dropdown-item waves-effect" href="<?= site_url('superadmin/faq/edit/')?><?=$d['id_faq']?>"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                              <?php } ?>
                            <?php if($role['delete_data'] == 'Y') {?>
                              <a class="dropdown-item waves-effect" href="<?= site_url('superadmin/faq/hapus/')?><?=$d['id_faq']?>"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a>
                              <?php } ?>
